...
**博客地址：
[https://blog.csdn.net/2303_76227485/article/details/143358435](https://blog.csdn.net/2303_76227485/article/details/143358435)**

**视频演示：
[https://www.bilibili.com/video/BV1hVSbYhEET/](https://www.bilibili.com/video/BV1hVSbYhEET/)**

**毕业设计所有选题地址：
[https://github.com/giteecode/allProject](https://github.com/giteecode/allProject)**

## 基于Java+Springboot+vue3的体育网站系统(源代码+数据库)194

## 一、系统介绍
本项目前后端分离(可以改为ssm版本)，分为用户、管理员两种角色
### 1、用户：
- 注册、登录、公告、商品信息(评论、收藏、购买、积分兑换)、购物车、广告信息、新闻、赛事视频、订单管理、地址管理、我的收藏、充值、个人信息、密码修改
### 2、管理员：
- 订单统计、新闻管理、类型管理、视频管理、轮播图管理、公告管理、商品管理、管理员管理、用户管理、广告管理、订单管理、发货、物流填写
